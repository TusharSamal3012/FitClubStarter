    ...
    return (
        <>
            <div className="header">
                ...
                {(menuOpened === false && mobile === true) ? (<div style={{ background: 'var(--appColor)', padding: '0.5rem', borderRadius: '5px' }} onClick={() => setMenuOpened(true)}><img src={bars} alt="" style={{ width: '1.5rem', height: '1.5rem' }} /></div>) : (<ul className='header-menu'>
                    ...
                    <li>
                        <Link onClick={() => setMenuOpened(false)} to='testimonials' span='true' smooth={true}>Testimonials</Link></li>
                </ul>)}
